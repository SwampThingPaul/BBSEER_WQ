...
- High level look at surface water quality by integrating multiple data sets together

- Very little difference in average and upper 95% CI geometric mean TP and TN concentrations (w/ some exceptions)
  - If mean and UCI deviate, suggests some variability in annual values and could be used target treatment/basin level actions 
...
- Some locations did not see change over time (i.e. near zero slope) but concentrations remain relatively elevated (S178, Miami River, etc.).
